...
public class GuestCheckoutUSAddressRegister {
	 ...
	 */
	@Test
	public void testGuestCheckoutUSAddressRegister() throws TatchaException {
	...
	private void checkoutGuest(WebDriver driver, Properties prop, Properties locator, User user) {
		...
		wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='login-fb-checkout']/div/div[1]/h1")));
