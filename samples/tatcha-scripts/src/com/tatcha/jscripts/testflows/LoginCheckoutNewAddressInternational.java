...
public class LoginCheckoutNewAddressInternational {
	...
	public void setUp() throws Exception {
		...
		data.load(new FileInputStream(
				getClass().getResource("/LoginCheckoutNewAddressInternational.properties").getFile()));
	 ...
	 */
	@Test
	public void testLoginCheckoutNewAddressInternational() throws TatchaException {
