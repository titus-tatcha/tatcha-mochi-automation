...
/**
 * Flow : Add to cart - Login in Checkout page - Add a new international address - Add Gift card - Place order
 * 
 * @author reshma
 *
 */
public class LoginCheckoutNewAddressInternational {
    ...
    public void setUp() throws Exception {
        ...
        data.load(new FileInputStream(getClass().getResource("/LoginCheckoutNewAddressInternational.properties").getFile()));
     ...
     * By adding a new address to address book
     * 
     * @throws Exception
     */
    @Test
    public void testLoginCheckoutNewAddressInternational() throws Exception {
        ...
        String FUNCTIONALITY = "Checkout as logged in user with a new address(International)";
        ...
        try {
            ...
            shipping.verifyShippingAddress4(driver, prop, locator, user, map, data, tcList);
