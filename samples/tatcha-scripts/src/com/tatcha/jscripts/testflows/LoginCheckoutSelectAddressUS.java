...
/**
 * Flow-5 : Add to cart - Login in Checkout page - Select a US address - Add
...
public class LoginCheckoutSelectAddressUS {
	...
	public void setUp() throws Exception {
		...
		data.load(new FileInputStream(getClass().getResource("/LoginCheckoutSelectAddressUS.properties").getFile()));
	 ...
	 */
	@Test
	public void testLoginCheckoutSelectAddressUS() throws TatchaException {
