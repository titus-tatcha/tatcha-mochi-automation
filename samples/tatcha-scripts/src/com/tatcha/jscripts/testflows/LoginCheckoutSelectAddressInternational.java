...
/**
 * Flow : Add to cart - Login in Checkout page - Select an international address - Add Gift card - Place order
 * 
 * @author reshma
 *
 */
public class LoginCheckoutSelectAddressInternational {
    ...
    public void setUp() throws Exception {
        ...
        data.load(new FileInputStream(getClass().getResource("/LoginCheckoutSelectAddressInternational.properties").getFile()));
