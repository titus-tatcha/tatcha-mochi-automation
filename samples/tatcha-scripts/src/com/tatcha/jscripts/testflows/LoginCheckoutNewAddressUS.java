...
/**
 * Flow-4 : Add to cart - Login in Checkout page - Add a new US address - Add
 * Gift card - Place order
 * 
 * @author reshma
 *
 */
public class LoginCheckoutNewAddressUS {
	...
	public void setUp() throws Exception {
		...
		data.load(new FileInputStream(getClass().getResource("/LoginCheckoutNewAddressUS.properties").getFile()));
	 ...
	 */
	@Test
	public void testLoginCheckoutNewAddressUS() throws TatchaException {
		...
		try {
			...
			shipping.verifyShippingAddress2(driver, prop, locator, user, map, tcList);
