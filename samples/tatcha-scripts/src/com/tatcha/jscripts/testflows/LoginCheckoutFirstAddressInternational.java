...
/**
 * Flow : Add to cart - Login in Checkout page - Add first international address - Select Credit card - Place order
 * 
 * @author reshma
 *
 */
public class LoginCheckoutFirstAddressInternational {
    ...
    public void setUp() throws Exception {
        ...
        data.load(new FileInputStream(getClass().getResource("/LoginCheckoutFirstAddressInternational.properties").getFile()));
