...
public class LoginCheckoutFirstAddressInternational {
	...
	public void setUp() throws Exception {
		...
		data.load(new FileInputStream(
				getClass().getResource("/LoginCheckoutFirstAddressInternational.properties").getFile()));
	 ...
	 */
	@Test
	public void testLoginCheckoutFirstAddressInternational() throws TatchaException {
