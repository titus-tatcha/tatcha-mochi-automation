...
public class BagUpdateQuantityEditReview {
    ...
    public void testBagUpdateQuantityEditReview() throws Exception {
        ...
        try {
            ...
            String merchTotalString = driver.findElement(By.xpath(bagLocator.getProperty("summary.merchtotal.value").toString())).getText();
            String orderTotalString = driver.findElement(By.xpath(bagLocator.getProperty("summary.total.value").toString())).getText();
            ...
            testSummary.testBagSummary(driver, prop, bagLocator, user, map, tcList);
            merchTotalString = driver.findElement(By.xpath(bagLocator.getProperty("summary.merchtotal.value").toString())).getText();
            orderTotalString = driver.findElement(By.xpath(bagLocator.getProperty("summary.total.value").toString())).getText();
            ...
            getTestHelper().logAssertion(getClass().getSimpleName(), orderTotalUpdated == orderTotal+(merchPriceUpdated-merchPrice));
