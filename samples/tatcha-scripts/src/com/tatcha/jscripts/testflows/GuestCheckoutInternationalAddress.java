...
public class GuestCheckoutInternationalAddress {
	...
	public void setUp() throws Exception {
		...
		data.load(
				new FileInputStream(getClass().getResource("/GuestCheckoutInternationalAddress.properties").getFile()));
	 ...
	 */
	@Test
	public void testGuestCheckoutInternationalAddress() throws TatchaException {
