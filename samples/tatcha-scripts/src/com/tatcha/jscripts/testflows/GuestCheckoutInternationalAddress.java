...
/**
 * Flow : Add to cart - Checkout as guest - Add international address - Add Gift card - Place order (as guest) 
 * 
 * @author reshma
 *
 */
public class GuestCheckoutInternationalAddress {
    ...
    public void setUp() throws Exception {
        ...
        data.load(new FileInputStream(getClass().getResource("/GuestCheckoutInternationalAddress.properties").getFile()));
