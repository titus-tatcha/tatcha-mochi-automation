package com.tatcha.jscripts.xlt.fullflow;
...
public class GuestFlow extends AbstractWebDriverScriptTestCase {
	...
	public void test() throws Throwable {
		...
		clickAndWait(
				"=id('navigation')/div[contains(@class,'content-asset')][1]/ul[contains(@class,'nav') and contains(@class,'navbar-nav')]/li[contains(@class,'dropdown') and contains(@class,'yamm-fw')][1]/div[contains(@class,'dropdown-menu') and contains(@class,'nav-mobile')][1]/div[contains(@class,'yamm-content') and contains(@class,'container-fluid')]/div[contains(@class,'row')]/div[contains(@class,'col-md-2') and contains(@class,'col-md-offset-1') and contains(@class,'nav-main-cat')][1]/ul[contains(@class,'list-unstyled') and contains(@class,'nav-mobile-section')]/li[1]/a");
		//
		// ~~~ GuestFlow-1 ~~~
		//
		startAction("Select Product");
		// clickAndWait("//*[@id='d437624aa8206c64cd1f962869']//img[contains(@class,'img-responsive')
		// and contains(@class,'product-img')]");
		...
		if (YES) {
			...
			// driver.findElement(By.xpath("button[contains(@type,'submit')]/span"));
