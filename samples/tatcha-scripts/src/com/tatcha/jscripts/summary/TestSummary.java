...
public class TestSummary {
     ...
     * @throws Exception
     */
    public void testSummary(WebDriver driver, Properties prop, Properties locator, User user, Map<String, Boolean> map,
     ...
     * @throws Exception
     */
    public void testBagSummary(WebDriver driver, Properties prop, Properties locator, User user,
     ...
     * @throws Exception
     */
    public void testEgiftSummary(WebDriver driver, Properties prop, Properties locator, User user,
            Map<String, Boolean> map, List<TestCase> tcList) throws Exception {
        ...
        String taxAmtString = driver.findElement(By.xpath(locator.getProperty("summary3.tax.value").toString()))
                .getText();
        String orderTotalString = driver
                .findElement(By.xpath(locator.getProperty("summary3.total.value").toString())).getText();
