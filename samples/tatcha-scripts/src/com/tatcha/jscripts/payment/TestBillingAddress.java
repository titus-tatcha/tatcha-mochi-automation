...
public class TestBillingAddress {
     ...
     * @throws Exception
     */
    public void testSelectNewBillingAddress(WebDriver driver, Properties prop, Properties locator, User user,
     ...
     * @throws Exception
     */
    public void testAddBillingAddress(WebDriver driver, Properties prop, Properties locator, User user,
            List<TestCase> tcList) throws Exception {
