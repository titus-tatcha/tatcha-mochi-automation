...
public class TestCreditCard {
     ...
     * @throws Exception
     */
    public void testAddFirstCreditCard(WebDriver driver, Properties prop, Properties locator, User user, List<TestCase> tcList) throws Exception {
        try {
...
//            By cardNameLabelLocator = By.xpath(locator.getProperty("guest.creditCard.name.label").toString());
//            By cardNumberLabelLocator = By.xpath(locator.getProperty("guest.creditCard.number.label").toString());
//            By expirationLabelLocator = By.xpath(locator.getProperty("guest.creditCard.epiration.label").toString());
//            By cvvLabelLocator = By.xpath(locator.getProperty("guest.creditCard.cvv.label").toString());
            ...
            getTestHelper().logAssertion(getClass().getSimpleName(), prop.getProperty("payment.creditCard.title").toString(), driver.findElement(creditCardTitleLocator).getText());
            
            // Verify Credit card fields
            getTestHelper().logAssertion(getClass().getSimpleName(), prop.getProperty("creditCard.name.label").toString(), driver.findElement(creditCardTitleLocator).getText());
            getTestHelper().logAssertion(getClass().getSimpleName(), prop.getProperty("creditCard.number.label").toString(), driver.findElement(creditCardTitleLocator).getText());
            getTestHelper().logAssertion(getClass().getSimpleName(), prop.getProperty("creditCard.epiration.label").toString(), driver.findElement(creditCardTitleLocator).getText());
            getTestHelper().logAssertion(getClass().getSimpleName(), prop.getProperty("creditCard.cvv.label").toString(), driver.findElement(creditCardTitleLocator).getText());
            
            // Braintree do not allow access of credit card fields, hence add gift card
    ...
    /**
     * Verify adding a new credit card to the list of 
     * available credit card during checkout
     * 
     * @param driver
     * @param prop
     * @param locator
     ...
     * @throws Exception
     */
    public void testAddCreditCard(WebDriver driver, Properties prop, Properties locator, User user, List<TestCase> tcList) throws Exception {
        ...
        try {
            ...
            getTestHelper().logAssertion(getClass().getSimpleName(), prop.getProperty("payment.addCard.button.label").toString(), driver.findElement(creditCardAddButtonLocator).getText());
            ...
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath(locator.getProperty("addcard.cancel.button").toString())));
            getTestHelper().logAssertion(getClass().getSimpleName(), prop.getProperty("payment.addCard.modalBox.title").toString(), driver.findElement(addCreditCardModalTitleLocator).getText());
            WebElement cancelButtonElement = driver.findElement(By.xpath(locator.getProperty("addcard.cancel.button").toString()));
     ...
     * @throws Exception
     */
    public void testSelectCreditCard(WebDriver driver, Properties prop, Properties locator, User user, List<TestCase> tcList) throws Exception {
        ...
        try {
            ...
            List<WebElement> creditCardListElement = driver.findElements(By.className(locator.getProperty("creditCard.selectCard.list").toString()));
            ...
            logger.info("Credit Cards are not present for the user");
        } catch (ElementNotVisibleException nv) {
            System.err.println(getClass().getSimpleName() + " : ELEMENT NOT VISIBLE " + nv.toString());
        } catch (TimeoutException te) {
            System.err.println(getClass().getSimpleName() + " : TIMEOUT " + te.toString());
