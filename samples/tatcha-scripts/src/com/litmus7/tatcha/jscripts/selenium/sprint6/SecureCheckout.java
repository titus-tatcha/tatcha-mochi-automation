...
public class SecureCheckout {
  ...
  public void secureCheckout(WebDriver driver){
	   // BEGIN Secure Checkout
	    ...
	    assertEquals("PAYMENT", driver.findElement(By.xpath("//html[@id='ext-gen45']/body/main/div/div/ul/li[2]/span")).getText());
	    assertEquals("REVIEW ORDER", driver.findElement(By.xpath("//html[@id='ext-gen45']/body/main/div/div/ul/li[3]/span")).getText());
	    ...
	    assertEquals("This field is required.", driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_firstName-error")).getText());
	    driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_lastName")).click();
	    assertEquals("Last Name", driver.findElement(By.xpath("//form[@id='dwfrm_singleshipping_shippingAddress']/div/div[2]/div/div/div/div[2]/label/span")).getText());
	    assertEquals("This field is required.", driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_lastName-error")).getText());
	    assertEquals("Country", driver.findElement(By.xpath("//form[@id='dwfrm_singleshipping_shippingAddress']/div/div[2]/div/div/div/div[3]/label")).getText());
	    new Select(driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_country"))).selectByVisibleText("Uganda");
	    ...
	    assertEquals("Address", driver.findElement(By.xpath("//form[@id='dwfrm_singleshipping_shippingAddress']/div/div[2]/div/div/div/div[4]/label/span")).getText());
	    assertEquals("This field is required.", driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_address1-error")).getText());
	    driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_address2")).click();
	    assertEquals("Address 2", driver.findElement(By.xpath("//form[@id='dwfrm_singleshipping_shippingAddress']/div/div[2]/div/div/div/div[5]/label/span")).getText());
	    driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_postal")).click();
	    assertEquals("ZIP Code", driver.findElement(By.xpath("//form[@id='dwfrm_singleshipping_shippingAddress']/div/div[2]/div/div/div/div[6]/div/div/div/label/span")).getText());
	    assertEquals("This field is required.", driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_postal-error")).getText());
	    assertEquals("State", driver.findElement(By.xpath("//form[@id='dwfrm_singleshipping_shippingAddress']/div/div[2]/div/div/div/div[6]/div[2]/div/div/label/span")).getText());
	    assertEquals("This field is required.", driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_states_state-error")).getText());
	    assertEquals("City", driver.findElement(By.xpath("//form[@id='dwfrm_singleshipping_shippingAddress']/div/div[2]/div/div/div/div[7]/label/span")).getText());
	    assertEquals("This field is required.", driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_city-error")).getText());
	    assertEquals("Phone", driver.findElement(By.xpath("//form[@id='dwfrm_singleshipping_shippingAddress']/div/div[2]/div/div/div/div[8]/div/label/span")).getText());
	    assertEquals("This field is required.", driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_phone-error")).getText());
	    ...
	    new Select(driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_country"))).selectByVisibleText("United Kingdom");
	    ...
	    driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_address1")).sendKeys("Acme Plc, Acme House");
	    driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_address2")).clear();
	    driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_address2")).sendKeys("3 Street, SouthHampton");
	    ...
	    driver.findElement(By.id("dwfrm_singleshipping_shippingAddress_addressFields_states_state")).sendKeys("England");
	    ...
	    assertEquals("Shipping Options", driver.findElement(By.xpath("//form[@id='dwfrm_singleshipping_shippingAddress']/div/div[2]/div[2]/h5")).getText());
	    assertEquals("Estimates based orders placed before 1pm Pacific Time. Orders placed after are normally shipped the next day.", driver.findElement(By.cssSelector("em")).getText());
	    ...
	    assertEquals("", driver.findElement(By.id("shipping-method-productmatrix_USPS_(7-10_Business_Days)")).getText());
	    ...
	    assertEquals("Add a gift box for this order. ($10.00)", driver.findElement(By.cssSelector("div.checkbox > label")).getText());
	    // checking Gift Message Cancel button
	    driver.findElement(By.id("hasGiftMessage")).click();
	    assertEquals("Add a Gift Message", driver.findElement(By.cssSelector("#giftMessageModal > div.modal-dialog > div.modal-content > div.modal-header > h4.modal-title > strong")).getText());
	    assertEquals("Message", driver.findElement(By.cssSelector("div.modal-body > div.form-group > label.control-label")).getText());
