...
public class ExpressCheckoutLoginNonUS {
    ...
    private final static Logger logger = Logger.getLogger(ExpressCheckoutLoginNonUS.class);
     ...
     * and also the default address should be an international address
     * 
     * @throws Exception
     */
    @Test
    public void testExpressCheckoutLoginNonUS() throws Exception {
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy_HH:mm:ss");
        String timeStamp = sdf.format(Calendar.getInstance().getTime());
        
        logger.info("VERIFYING CHECKOUT FLOW FOR LOGGED IN USER WITH INTERNATIONAL ADDRESS : "+getClass()+timeStamp);
    ...
    private void checkoutLogin(WebDriver driver, Properties prop, Properties locator, User user) {
        ...
        emailIdElement.sendKeys("nonus@test.com");
