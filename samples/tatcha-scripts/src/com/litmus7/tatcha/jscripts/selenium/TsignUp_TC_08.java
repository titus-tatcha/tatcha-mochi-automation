...
//    driver = new FirefoxDriver();
  ...
  @Test
  public void testTsignUpTC08() throws Exception {
    ...
    driver.findElement(By.id("dwfrm_profile_customer_email")).sendKeys("@test.com");
    driver.findElement(By.id("dwfrm_profile_customer_emailconfirm")).clear();
    driver.findElement(By.id("dwfrm_profile_customer_emailconfirm")).sendKeys("@test.com");
    ...
    assertEquals("It should show the validation message for incorrect password.", driver.getTitle());
  }
